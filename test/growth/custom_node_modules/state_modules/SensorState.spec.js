...
describe('SensorState.js tests', function() {
  ...
  describe('getSensorVal() tests', function() {
    it('should get a value from the sensor', async function() {
      let test_state = await new SensorState()
  ...
  describe('writeSensorIndexDataToFile() tests', function() {
    it('should call writeFile once', async function() {
      let actual = await new SensorState()
    ...
    it('should try to call writeFile but error and print', async function() {
      let actual = await new SensorState()
