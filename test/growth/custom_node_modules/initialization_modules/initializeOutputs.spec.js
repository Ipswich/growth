...
describe('initializeOutputs.js tests', function() {  
  describe('initializeOutputs() tests', function() {
    it('should attach a relay control pin to state, update event listeners', function() {
      ...
      initializeOutputs.initializeOutputs(test_state)
    ...
    it('should run out of (output) pins and throw an error', function() {
      ...
      assert.throws(function() {initializeOutputs.initializeOutputs(test_state, dummy_board)}, "Error!")
    })
