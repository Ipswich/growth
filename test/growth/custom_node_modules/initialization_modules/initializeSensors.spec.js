...
describe('initializeSensors.js tests', () => {  
  describe('initializeSensors tests', () => {
    it('should add no sensors', () => {
      let test_state = {
        sensorState: {
          data:[
            {
    ...
    it('should add 2 addressed and 2 unaddressed DS18B20s', async () => {
      let test_state = {        
        sensorState: {
          data:[
            {
    ...
    it('should add a generic hygrometer object', async () => {
      let test_state = {        
        sensorState: {
          data:[
            {
    ...
    it('should add a generic thermometer object', async () => {
      let test_state = {        
        sensorState: {
          data:[
            {
    ...
    it('should add a generic barometer object', async () => {
      let test_state = {        
        sensorState: {
          data:[
            {
    ...
    it('should fail on adding a sensor and reject', async () => {
      let test_state = {        
        sensorState: {
          data:[
            {
      ...
      await initializeSensors.initializeSensors(test_state).then(() => {
        // Error on success
