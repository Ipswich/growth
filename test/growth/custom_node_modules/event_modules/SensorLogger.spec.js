...
const sensorLogger = require('../../../../custom_node_modules/event_modules/sensorLogger')


describe('sensorLogger.js tests', () => {  
  describe('sensorLogger tests', () => {
    it('should get readings from 3 sensors and add to database', async () => {
