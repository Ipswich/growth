...
function resetModules() {
  delete require.cache[require.resolve('../../../../../custom_node_modules/event_modules/event_handlers/sensorEventHandler')];
  sensorEventHandler = require('../../../../../custom_node_modules/event_modules/event_handlers/sensorEventHandler');
}

describe('sensorEventHandler.js tests', () => {
  const test_schedule = [
    {
      scheduleID: 1,
      sensorID: 1,
  ...
  describe('sensorEventHandler() tests', () => {
    ...
    it('should not call triggerEvent (wrong value)', async () => {
