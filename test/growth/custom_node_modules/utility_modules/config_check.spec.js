...
function resetModules() {
  delete require.cache[require.resolve('../../../../custom_node_modules/utility_modules/config_check')];
  config_check = require('../../../../custom_node_modules/utility_modules/config_check');
}
...
describe('getInput() tests', () => {
  ...
  it('should print query', async () => {
    ...
    await config_check.getInput('QUERY!')
  ...
  it('should return input', async () => {
    ...
    sinon.stub(readline, 'createInterface').returns(readlineInterfaceStub);
    const actual = await config_check.getInput()
...
describe('initializeConfig() tests', () => {
  ...
  it('should resolve with the system config', async () => {
    ...
    let actual = await config_check.initializeConfig()
  ...
  it('should reject promise on failed config copy', async () => {
    ...
    await config_check.initializeConfig().then(
...
describe('getBoardData() tests', () => {
  it('should return an array of board data', () => {
    ...
    let result = config_check.getBoardData()
...
describe('boardCheck() tests', () => {
  ...
  it('should return an array of a board object and "true"', async () => {
    ...
    sinon.stub(config_check, 'getInput').resolves("test1")
    sinon.stub(config_check, 'getBoardData').returns(getBoardData_return)
    let actual = await config_check.boardCheck({'board' : 'null'}, false)
  ...
  it('should return the passed object and "true"', async () => {
    ...
    let actual = await config_check.boardCheck(expected, true)
...
describe('databaseCheck() tests', () => {
  ...
  it('should return an array of a database object and "true"', async () => {
    ...
    sinon.stub(config_check, 'getInput').resolves("test1")
    let actual = await config_check.databaseCheck(test_config, false)
    expect(actual[0]).to.be.eql(expected)
    expect(actual[1]).to.be.true
  ...
  it('should return the passed object and "true"', async () => {
    let expected = { database: { password: 'test1' } }
    let actual = await config_check.databaseCheck(expected, true)
    expect(actual[0]).to.be.eql(expected)
    expect(actual[1]).to.be.true
  })
})
...
describe('jwtCheck() tests', () => {
  it('should return an array of a jwt_secret object and "true"', async () => {
    ...
    sinon.stub(config_check, 'getInput').resolves("test1")
    let actual = await config_check.jwtCheck(test_config, false)
    expect(actual[0]).to.be.eql(expected)
    expect(actual[1]).to.be.true
  ...
  it('should return the passed object and "true"', async () => {
    let expected = { jwt_secret: 'test1' }
    let actual = await config_check.jwtCheck(expected, true)
    expect(actual[0]).to.be.eql(expected)
    expect(actual[1]).to.be.true
  })
})
...
describe('nodeMailerCheck() tests', () => {
  ...
  it('should return a filled array of nodeMailer object, "true", and "true"', async () => {
    ...
    getInput_fn = sinon.stub(config_check, 'getInput').onCall(0).resolves('y')
    getInput_fn.onCall(1).resolves('gmail')
    getInput_fn.onCall(2).resolves('test@example.com')
    getInput_fn.onCall(3).resolves('password')
    let actual = await config_check.nodemailerCheck(test_config, false, true)
  ...
  it('should return an array of the passed object, "false", and "false"', async () => {
    ...
    sinon.stub(config_check, 'getInput').resolves('')
  ...
  it('should return an array of the passed object, "true", and "false"', async () => {
    ...
    let getInput_fn = sinon.stub(config_check, 'getInput').onCall(0).resolves('')
...
describe('relayTogglePreventionCheck() tests', () => {
  ...
  it('should return an array of an object with true, and "true"', async () => {
    ...
    sinon.stub(config_check, 'getInput').resolves('y')
    let actual = await config_check.relayTogglePreventionCheck(test_config, false)
  ...
  it('should return an array of an object with false, and "true"', async () => {
    ...
    sinon.stub(config_check, 'getInput').resolves('n')
    let actual = await config_check.relayTogglePreventionCheck(test_config, false)
...
describe('configUpdate() tests', () => {
  it('should update config', () => {
    ...
    config_check.configUpdate(config, true)    
  ...
  it('should not update config', () => {
    ...
    config_check.configUpdate(config, false)
...
describe('configChecker() tests', () => {
  it('should return true', async () => {
    let test_config = {}
    sinon.stub(config_check, 'boardCheck').resolves([test_config, true])
    sinon.stub(config_check, 'databaseCheck').resolves([test_config, true])
    sinon.stub(config_check, 'jwtCheck').resolves([test_config, true])
    sinon.stub(config_check, 'nodemailerCheck').resolves([test_config, true, false])
    sinon.stub(config_check, 'relayTogglePreventionCheck').resolves([test_config, true])
    sinon.stub(config_check, 'configUpdate').resolves([test_config, true])
    let actual = await config_check.configChecker(test_config, true)
    expect(actual).to.be.true
  })
  it('should call process.exit(-1)', async () => {
    let test_config = {}
    sinon.stub(config_check, 'boardCheck').throws(new Error("ERROR!"))
    sinon.stub(process, 'exit').callsFake()
    await config_check.configChecker(test_config, true)    
    sinon.assert.calledOnce(process.exit)
  })
})