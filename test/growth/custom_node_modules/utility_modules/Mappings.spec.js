...
describe('Mappings.js tests', () => {
  ...
  describe('getOutputMappings() tests', async () => {
    it('should call mapOutputPins referencing the database', async () =>{
      ...
      sinon.stub(mappings,'getBoardMapping').returns(standard_board_mappings_return)
  ...
  describe('mapSensorPins() tests', () => {
    ...
    it('Error and exit on counting passed END_SENSOR_PIN', async () => {
    ...
    it('Error and exit on counting passed END_ANALOG_PIN', async () => {
      var sensor_pin_mappings_return = {
        START_ANALOG_PIN: 21,
        END_ANALOG_PIN: 20,
      }
