...
describe('Mappings.js tests', function() {
  ...
  describe('getBoardMapping() tests', function() {
    beforeEach(function() {
      resetModules();
    });
    let board_fixture = {
    ...
    it('should set and return a parsed JSON object', function() {
      ...
      sinon.stub(fs, 'readFileSync').returns(board_fixture) 
      assert.deepEqual(mappings.getBoardMapping(), {})
    })
    it('should call fs.readFileSync() only once, returning the board from the initial call', function() {
      sinon.stub(config_helper, 'getConfig').returns({board: "test"})
      let fs_stub = sinon.stub(fs, 'readFileSync').returns(board_fixture)
  ...
  describe('mapOutputPins() tests', function() {
    ...
    it('should run out of digital pins and call process.exit()', function() {
    ...
    it('should run out of PWM pins and call process.exit()', function() {
  ...
  describe('mapSensorPins() tests', function() {
    ...
    it('Error and exit on running out of sensor pins', async function() {
    ...
    it('Error and exit on running out of analog pins', async function() {
      var sensor_pin_mappings_return = {
        SENSOR_PINS : [1],
        ANALOG_PINS : []
      }
