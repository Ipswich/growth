...
describe('utils.js tests', function() {
  ...
  describe("getLatestImageName() tests", function() {
    it('should return the name of the most recent image', async function() {
      sinon.stub(config_helper, 'getConfig').returns({camera:{image_directory: "/test"}})
      sinon.stub(fsPromises, 'readdir').resolves(['test1.txt', 'test2.txt'])
      ...
      assert.equal(await utils.getLatestImageName(), 'test1.txt')
    })
    ...
    it('should throw an error', async function() {
      ...
      try {
        await utils.getLatestImageName()
        assert.fail()
      } catch (e){
