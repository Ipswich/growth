...
module.exports.initialize = async function initialize(state, app) {
  ...
  doneEmitter.once('booted', async () => {
      ...
      relay_control = createRelayControlObject(config, board) 
      await initializeOutputs(state, config, board)
...
async function initializeOutputs(state, board) {
...
function createRelayControlObject(config, board){
  ...
  if(config.relay_toggle_prevention){
    ...
    let relay_control = new five.Pin(relay_toggle_pin)
    //Handle board interrupts (turn off stuff)
    board.on('exit', () => {
      relay_control.low()           
    })
...
module.exports.createRelayControlObject = createRelayControlObject