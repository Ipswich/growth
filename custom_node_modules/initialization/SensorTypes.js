...
module.exports.I2CFilter = function I2CFilter(counter, obj, currentState){
  if(counter == currentState.sensorHardwareID && currentState.sensorProtocol == 'I2C'){
    if(currentState.sensorModel == "BME280"){
      obj.address = i2c_addresses.BME280_ADDRESS;
    }
  }
  return
}
