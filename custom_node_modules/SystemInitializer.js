...
module.exports.initialize = async function initialize(state, app) {
  ...
  doneEmitter.once('booted', async () => {
      ...
      await initializeSensors(state, config)
  ...
  return new Promise(async (resolve) => {
    let DS18B20_result = DS18B20initializer(state)
    DS18B20_Count = DS18B20_result.count
    DS18B20_Pin = DS18B20_result.pin    
    ...
    board.once("ready", function() {             
      if(config.board == 'test'){
        ...
        DS18B20AddressFilter(DS18B20_Count, DS18B20_Pin, DS18B20_Array, state, doneEmitter)
      }      
    })
  });
}
...
async function initializeSensors(state, config) {
  return new Promise((resolve) => {
...
function DS18B20Initializer(state){
...
module.exports.DS18B20Initializer = DS18B20Initializer
...
function DS18B20AddressFilter(DS18B20_Count, DS18B20_Pin, DS18B20_Array, state, doneEmitter) {
  if (DS18B20_Count != 0) {
...
module.exports.DS18B20AddressFilter = DS18B20AddressFilter