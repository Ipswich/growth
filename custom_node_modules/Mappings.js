...
const SDAPIN = 20;
const SCLPIN = 21;
//Start and End Analog Pins on Arduino Mega (concatenate A onto front)
const START_ANALOG_PIN = 0;
const END_ANALOG_PIN = 15;
...
module.exports.getSensorMappings = async function getSensorMapings() {
...
function mapSensorPins(sensors) {
  let sensorPin = START_ANALOG_PIN;
  ...
  for(i = 0; i < sensors.length; i++) {
    ...
    switch (sensors[i].sensorProtocol) {
      case "I2C":
        break;
      case "ANALOG":
        sensors[i].SENSOR_PIN = "A" + sensorPin;
        sensorPin++;
        break;
      case "ONEWIRE":
        sensors[i].SENSOR_PIN = "A" + sensorPin;
