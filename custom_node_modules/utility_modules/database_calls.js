 ...
 * @returns {Promise} A promise that resolves with results of a simple query to test 
 * connectivity. 
 */
 ...
 * event.
 * @returns {Promise} A promise that resolves with the results of the query - this is 
 * insert only.
 */
 ...
 * @returns {Promise} A promise that resovles with the results of the query.
 */
