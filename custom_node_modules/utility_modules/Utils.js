...
module.exports.getIndexData = async function getIndexData(res, req, interval = CHART_INTERVAL){
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      var data = Object.assign({}, web_data, sensorTypes, sensorData, sensorLast12, scheduleData, outputs, events, sensors, intervals, authenticated);
      ...
      var packet = Object.assign({}, schedulesPug, currentConditionsPug, addEventPug, data);
      resolve(packet);
    } catch (e) {
      //If error, error
      reject(e);
