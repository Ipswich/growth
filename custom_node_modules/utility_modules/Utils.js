...
module.exports.getIndexData = async function getIndexData(req){
  return new Promise(async (resolve, reject) => {
    ...
    try {
      ...
      let sensorLast12 = await dbcalls.getSensorLastReadingsByHours(12)
      ...
      var data = Object.assign({}, web_data, sensorTypes, sensorData, sensorLast12, scheduleData, outputs, events, sensors);
