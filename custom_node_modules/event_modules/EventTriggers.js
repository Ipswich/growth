  ...
  switch (switchCase) {
    case 'Output On':
      if(output.outputController == "Manual"){
        ...
        if(output.lastOutputController == 'Schedule' && output.scheduleState == "Output On" && output.scheduleOutputValue == schedule.outputValue) {          
        ...
        if(output.lastOutputController == 'Manual' && output.manualState == "Output On" && output.manualOutputValue == schedule.outputValue) {
      ...
      if(output.outputPWMPin != null) {
        console.log(currentTime + "  " + output.outputName + ": [" + output.outputController + "] ON @ " + schedule.outputValue + "% - [Output Pin: " + output.outputPin + ", PWM Pin: " + output.outputPWMPin + "]");      
      } else {
        console.log(currentTime + "  " + output.outputName + ": [" + output.outputController + "] ON - [Output Pin: " + output.outputPin + "]");      
      }
      // Turn on relay
      if(output.outputPWMObject){
        ...
        console.log(output.manualOutputValue)
    ...
    case 'Output Off':
      ...
      //Otherwise, update state and log and do stuff
      console.log(currentTime + "  " + output.outputName + ": [" + output.outputController + "] OFF - [Output Pin: " + output.outputPin + "]");  
...
module.exports.resumeSchedule = function resumeSchedule(output){
  let currentTime = '[' + moment().format('HH:mm') + ']'
  if (output.scheduleState == 'Output On') {
    ...
    if(output.outputPWMPin != null) {
      console.log(currentTime + "  " + output.outputName + ": [" + output.outputController + "] ON @ " + output.scheduleOutputValue + "% - [Output Pin: " + output.outputPin + ", PWM Pin: " + output.outputPWMPin + "]");      
    } else {
      console.log(currentTime + "  " + output.outputName + ": [" + output.outputController + "] ON - [Output Pin: " + output.outputPin + "]");      
    }
    output.outputObject.close()
