...
module.exports.sensorEventHandler = async function sensorEventHandler(state){
  ...
  let schedule = await utils.getSchedule('Sensor');
  ...
  if (events == undefined || schedule == undefined) {
    ...
    throw new Error("sensorEventHandler.js: sensorEventHandler() failed!")
  } else {
    ...
    for(let i = 0; i < schedule.length; i++) { 
      ...
      let sensorVal = state.sensorState.getSensor(schedule[i].sensorID).sensorLastReading.val
